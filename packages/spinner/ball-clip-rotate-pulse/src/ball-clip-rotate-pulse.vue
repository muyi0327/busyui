<style lang="scss">
  ...
  .wui-ball-clip-rotate-pulse {
    position: relative;
    display: inline-block;
    box-sizing: border-box;
  }
  
  .wui-ball-clip-rotate-pulse>div {
  ...
  .wui-ball-clip-rotate-pulse>div:first-child {
  ...
  .wui-ball-clip-rotate-pulse>div:last-child {
    position: absolute;
    border-width: 2px;
    border-style: solid;
...
<template>
  <div v-if="visiable" class="wui-ball-clip-rotate-pulse" :style="{width: width + 'px', height: width + 'px'}">
