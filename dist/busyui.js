(function (global, factory) {
    ...
    var __vue_scope_id__$2 = "data-v-59f047dc";
    /* module identifier */
    ...
    var __vue_scope_id__$4 = "data-v-08c109da";
    /* module identifier */
    ...
    var __vue_scope_id__$6 = "data-v-5d974590";
    /* module identifier */
      ...
      computed: {
        ...
        styles: function styles() {
          var width = this.width,
              ...
              ghost = this.ghost;
          width = cmpUnit(width);
          height = cmpUnit(height);
          radius = cmpUnit(radius);
          return {
            width: width,
            height: height,
            borderRadius: radius,
    ...
    var __vue_render__$e = function __vue_render__() {
      ...
      }, [_vm._t("default", [_vm._v(_vm._s(_vm.content))])], 2), _vm._v(" "), _vm.thin ? _c("span", {
    ...
    var __vue_scope_id__$e = "data-v-1efe833c";
    /* module identifier */
    ...
    var __vue_render__$g = function __vue_render__() {
      ...
      return _c("FlexBox", {
        ...
        "class": _vm.prefixCls + "-list-item__content",
        attrs: {
          flexible: true,
          "align-cross": "center"
        }
    ...
    var __vue_render__$i = function __vue_render__() {
      ...
      return _c("List", [_c("ListItem", [_c("Checkbox")], 1)], 1);
    };
    ...
    var __vue_scope_id__$i = "data-v-6cd41d79";
    /* module identifier */
    ...
    var CheckboxList = normalizeComponent_1({
    ...
    var __vue_scope_id__$j = "data-v-7470d86e";
    /* module identifier */
    ...
    var script$k = {
      ...
      computed: {
        currentDatas: function currentDatas() {
          var rst = [],
              spin = this.spin;

          for (var i = spin.start; i <= spin.end; i++) {
            rst.push({
              val: this.getVal(i),
              index: i
            });
      ...
      methods: {
        ...
        getPickerVal: function getPickerVal(d) {
          var index = Math.round(-1 * d / this.itemHeight);
        ...
        setItemStyle: function setItemStyle(i) {
          return {
            visibility: this.type === 'line' && i < 0 || i > this.datas.length - 1 ? 'hidden' : '',
            transform: "rotate3d(1, 0, 0, ".concat(-i * 20 % 360, "deg) translate3d(0px, 0px, 100px)")
          };
        },
        init: function init(type) {
          ...
          this.$nextTick(function () {
            if (!type) {
              ...
              _this.startTime = 0;
              _this.endTime = 0;
              var val = Array.isArray(_this.currentValue) ? _this.currentValue[_this.index] : _this.currentValue;

              _this.goValue(val);
            }
          });
        },
        goValue: function goValue(val) {
          //let val = Array.isArray(this.currentValue) ? this.currentValue[this.index] : this.currentValue
          var index = this.datas.indexOf(val);
          this.goIndex(index);
        },
        ...
        transitionTo: function transitionTo(distance, type, time) {
          var _this2 = this;

          var singleHeight = this.itemHeight;
          var deg = this.itemDeg;
          var singleDeg = deg / singleHeight; // 总的变化幅度

          var updateDistance = Number(this.transformY) + distance;
          var updateDeg, spinAim, margin, endMove, endDeg;
          ...
          if (type === 'end') {
            ...
            setTimeout(function () {
              return _this2.getPickerVal(endMove);
            }, this.transitionTime);
          } else {
        ...
        setWheelDeg: function setWheelDeg(updateDeg, type, time) {
          time = time || this.transitionTime;

          if (type === 'end') {
            this.$refs.wheel.style.webkitTransition = "transform ".concat(time, "ms cubic-bezier(0.19, 1, 0.22, 1)");
            this.$refs.wheel.style.webkitTransform = "rotate3d(1, 0, 0, ".concat(updateDeg, "deg)");
          } else {
        ...
        _end: function _end(e) {
          var pointer = e.changedTouches[0];
          this.endY = pointer.pageY;
          this.endTime = Date.now(); // 手指滑动总的距离

          var distance = this.endY - this.startY; // 手指滑动总的时间

          var time = this.endTime - this.startTime; // 平均速度

          var v = distance / time; // 加速度
    ...
    var __vue_render__$k = function __vue_render__() {
      ...
      return _c("div", {
        "class": [_vm.prefixCls + "-picker__wheel"]
      }, [_c("ul", {
        ref: "wheel",
        "class": _vm.prefixCls + "-picker__wheel-list"
      }, _vm._l(_vm.currentDatas, function (item, $i) {
        return _c("li", {
          key: $i,
          "class": _vm.prefixCls + "-picker__item",
          style: _vm.setItemStyle(item.index)
        }, [_c("p", [_vm._v(_vm._s(item.val.label || item.val))])]);
      }), 0)]);
    };
    ...
    var PickerWheel = normalizeComponent_1({
    ...
    var script$l = {
      ...
      watch: {
        ...
        cacheValue: function cacheValue(val) {
          console.log(val);
        }
      },
      methods: {
        ...
        initCache: function initCache() {
          this.cacheValue = Array.isArray(this.currentValue) ? _toConsumableArray(this.currentValue) : this.currentValue;
        }
      },
      mounted: function mounted() {
        this.cacheValue = Array.isArray(this.currentValue) ? _toConsumableArray(this.currentValue) : this.currentValue;
    ...
    var __vue_render__$l = function __vue_render__() {
      ...
      return _c("NativeMask", {
      ...
      }, [_vm._v(_vm._s(_vm.title))]), _vm._v(" "), _vm.needConfirm ? _c("span", {
        ...
        return _c("Wheel", {
          ...
          model: {
            value: _vm.cacheValue,
            callback: function callback($$v) {
              _vm.cacheValue = $$v;
            },
            expression: "cacheValue"
          }
        });
      })), _vm._v(" "), _c("div", {
    ...
    var __vue_render__$C = function __vue_render__() {
      ...
      return _c("li", {
        "class": _vm.prefixCls + "-select__item",
        on: {
          click: function click($event) {
            $event.stopPropagation();
    ...
    var __vue_render__$D = function __vue_render__() {
      ...
      return _c("div", {
        ...
        "class": _vm.prefixCls + "-select__content"
      }, [_c("input", {
        directives: [{
          name: "model",
          rawName: "v-model",
        ...
        "class": _vm.prefixCls + "-select__input",
        ...
        "class": _vm.prefixCls + "-select__options",
        style: _vm.optionStyles
      }, [_c("ul", {
        "class": [_vm.prefixCls + "-select__list", _vm.prefixCls + "-select__list- + " + _vm._uid],
        on: {
